...
- [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ([v0.321.0](https://github.com/googleapis/google-cloud-php/releases/tag/v0.321.0), 4 days ago) - Google Cloud Client Library for PHP
...
- [beste/latlon-geohash-php](https://github.com/beste/latlon-geohash-php) ([1.5.0](https://github.com/beste/latlon-geohash-php/releases/tag/1.5.0), 4 weeks ago) - 🌍 Gustavo Niemeyer&#39;s geocoding system
...
- [Add App Check replay protection with transitional contract](https://github.com/beste/firebase-php/pull/1073) on [beste/firebase-php](https://github.com/beste/firebase-php) (3 days ago)
...
- [Update link to the unofficial PHP Admin SDK](https://github.com/firebase/firebaseopensource.com/pull/428) on [firebase/firebaseopensource.com](https://github.com/firebase/firebaseopensource.com) (4 weeks ago)
...
- [DrCatHicks/learning-opportunities](https://github.com/DrCatHicks/learning-opportunities) - A Claude Code skill for deliberate skill development during AI-assisted coding (1 day ago)
- [vmfunc/sif](https://github.com/vmfunc/sif) - the blazing-fast pentesting suite. (2 days ago)
...
- [OpenHub-Store/GitHub-Store](https://github.com/OpenHub-Store/GitHub-Store) - A free, open-source app store for GitHub releases — browse, discover, and install apps with one click. Powered by Kotlin and Compose Multiplatform for Android &amp; Desktop (Linux, MacOS, Windows). (4 days ago)
- [f/textream](https://github.com/f/textream) - Textream is a free macOS teleprompter app for streamers, interviewers, and presenters. It highlights your script in real-time as you speak, displayed in a beautiful Dynamic Island overlay. With extensible features. (4 days ago)
...
- [wesm/msgvault](https://github.com/wesm/msgvault) - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB (5 days ago)
- [daijinhai/TermClean](https://github.com/daijinhai/TermClean) -  (5 days ago)
