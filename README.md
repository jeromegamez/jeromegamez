...
- [milanvarady/Applite](https://github.com/milanvarady/Applite) ([v1.2.2](https://github.com/milanvarady/Applite/releases/tag/v1.2.2), 4 days ago) - User-friendly GUI macOS application for Homebrew Casks
- [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ([v0.224.0](https://github.com/googleapis/google-cloud-php/releases/tag/v0.224.0), 5 days ago) - Google Cloud Client Library for PHP
...
- [utopia-php/framework](https://github.com/utopia-php/framework) - Lite &amp; fast micro PHP framework that is **easy to learn**. (1 day ago)
...
- [httpie/desktop](https://github.com/httpie/desktop) - 🚀 HTTPie Desktop — cross-platform API testing client for humans. Painlessly test REST, GraphQL, and HTTP APIs. (3 weeks ago)
