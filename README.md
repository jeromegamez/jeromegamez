...
- [milanvarady/Applite](https://github.com/milanvarady/Applite) ([v1.2.3](https://github.com/milanvarady/Applite/releases/tag/v1.2.3), 1 day ago) - User-friendly GUI macOS application for Homebrew Casks
- [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ([v0.236.0](https://github.com/googleapis/google-cloud-php/releases/tag/v0.236.0), 4 days ago) - Google Cloud Client Library for PHP
- [mongodb/laravel-mongodb](https://github.com/mongodb/laravel-mongodb) ([4.1.2](https://github.com/mongodb/laravel-mongodb/releases/tag/4.1.2), 5 days ago) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
...
- [php-tui/cli-parser](https://github.com/php-tui/cli-parser) - Type-safe CLI argument parser (5 days ago)
