...
- [jeromegamez/ramsey-uuid-normalizer](https://github.com/jeromegamez/ramsey-uuid-normalizer) ([3.1.0](https://github.com/jeromegamez/ramsey-uuid-normalizer/releases/tag/3.1.0), 1 day ago) - Symfony Normalizer and Denormalizer for ramsey/uuid
...
- [googleapis/google-cloud-php](https://github.com/googleapis/google-cloud-php) ([v0.229.0](https://github.com/googleapis/google-cloud-php/releases/tag/v0.229.0), 6 days ago) - Google Cloud Client Library for PHP
- [beste/in-memory-cache-php](https://github.com/beste/in-memory-cache-php) ([1.0.0](https://github.com/beste/in-memory-cache-php/releases/tag/1.0.0), 1 week ago) - A PSR-6 In-Memory cache that can be used as a fallback implementation and/or in tests.
- [kreait/firebase-php](https://github.com/kreait/firebase-php) ([7.9.1](https://github.com/kreait/firebase-php/releases/tag/7.9.1), 2 weeks ago) - Unofficial Firebase Admin SDK for PHP
- [kreait/laravel-firebase](https://github.com/kreait/laravel-firebase) ([5.5.0](https://github.com/kreait/laravel-firebase/releases/tag/5.5.0), 2 weeks ago) - A Laravel package for the Firebase PHP Admin SDK
- [kreait/firebase-bundle](https://github.com/kreait/firebase-bundle) ([5.1.1](https://github.com/kreait/firebase-bundle/releases/tag/5.1.1), 2 weeks ago) - A Symfony Bundle for the Firebase PHP Admin SDK
...
- [beste/latlon-geohash-php](https://github.com/beste/latlon-geohash-php) ([1.2.0](https://github.com/beste/latlon-geohash-php/releases/tag/1.2.0), 3 weeks ago) - 🌍 Gustavo Niemeyer&#39;s geocoding system
- [beste/json](https://github.com/beste/json) ([1.3.0](https://github.com/beste/json/releases/tag/1.3.0), 3 weeks ago) - A simple JSON helper to decode and encode JSON

#### 🔨 My recent Pull Requests

- [Release 8.0](https://github.com/kreait/firebase-php/pull/847) on [kreait/firebase-php](https://github.com/kreait/firebase-php) (3 weeks ago)
- [Add support for setting additional options when creating the Firestore component](https://github.com/kreait/firebase-php/pull/840) on [kreait/firebase-php](https://github.com/kreait/firebase-php) (4 weeks ago)
...
- [WyriHaximus/phpstan-reactphp](https://github.com/WyriHaximus/phpstan-reactphp) - ReactPHP extension for PHPStan (1 day ago)
- [staabm/phpstan-todo-by](https://github.com/staabm/phpstan-todo-by) - Todo comments with expiration date/version (1 day ago)
- [barryvdh/composer-cleanup-plugin](https://github.com/barryvdh/composer-cleanup-plugin) - Composer plugin for cleaning up unused files from packages. (6 days ago)
- [peter-evans/create-or-update-comment](https://github.com/peter-evans/create-or-update-comment) - A GitHub action to create or update an issue or pull request comment (1 week ago)
- [alpipego/workerist](https://github.com/alpipego/workerist) - Cloudflare worker for serverless private PHP package repository. (1 week ago)
...
- [magnuswikhog](https://github.com/magnuswikhog) (6 days ago)
- [therohitdas](https://github.com/therohitdas) (2 weeks ago)
- [tristan-bellosta](https://github.com/tristan-bellosta) (3 weeks ago)
